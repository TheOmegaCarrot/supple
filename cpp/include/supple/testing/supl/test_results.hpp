...
public:
   ...
   */
    ...
    void enforce_equal(
      const T& result, const U& expected,
      const std::string_view message = ""
    ) noexcept
    {
        m_case_count += 1;
   ...
   */
    /* }}} */
    template <typename T, typename U>
    void enforce_not_equal(
      const T& result, const U& unexpected,
      const std::string_view message = ""
    ) noexcept
    {
        m_case_count += 1;
   ...
   */
    /* }}} */
    inline void
    enforce_true(bool result, const std::string_view message = "") noexcept
    {
        m_case_count += 1;
   ...
   */
    /* }}} */
    inline void enforce_false(
      bool result, const std::string_view message = ""
    ) noexcept
    {
        m_case_count += 1;
   ...
   */
    ...
    inline void enforce_floating_point_approx(
      double result, double expected, double tolerance = 0.001,
      const std::string_view message = ""
    ) noexcept
    {
        m_case_count += 1;
