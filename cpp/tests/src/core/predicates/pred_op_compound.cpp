...
auto main() -> int
{
    ...
    results.enforce_false(
      test_pred_1(10), "10 not in ([3, 7] U [12, 17])"
    );
    results.enforce_false(
      test_pred_1(11), "11 not in ([3, 7] U [12, 17])"
    );
    ...
    results.enforce_false(
      test_pred_1(18), "18 not in ([3, 7] U [12, 17])"
    );
    results.enforce_false(
      test_pred_1(19), "19 not in ([3, 7] U [12, 17])"
    );
    results.enforce_false(
      test_pred_1(20), "20 not in ([3, 7] U [12, 17])"
    );
