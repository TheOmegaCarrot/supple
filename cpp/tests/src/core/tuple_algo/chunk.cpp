...
auto standard2() -> supl::test_results
{
    ...
    constexpr static std::tuple input {
      42,  false,
      'r', std::pair {12, '&'},
      'E', std::tuple {81, short {42}, true},
      18L, std::size_t {8196}
    };

    constexpr static std::tuple<
      std::tuple<int, bool>, std::tuple<char, std::pair<int, char>>,
...
auto standard3() -> supl::test_results
{
  ...
  constexpr static std::tuple input {
    ...
    constexpr static std::tuple<
      ...
      std::tuple<
        short, char, long, float, char, std::nullptr_t, unsigned,
        unsigned long long>>
      expected
      // clang-format off
  {
...
auto chunk_by_1() -> supl::test_results
{
    ...
    constexpr static std::tuple<
      std::tuple<int>, std::tuple<double>, std::tuple<bool>,
