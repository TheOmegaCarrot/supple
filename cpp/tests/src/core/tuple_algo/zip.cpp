  ...
  supl::tuple::zip(
    overload {
      ...
      [&](int idx, int arg1, long arg2, char arg3) {
        results.enforce_equal(std::tie(idx, arg1, arg2, arg3), expected1);
      },
      [&](int idx, char arg1, bool arg2, std::size_t arg3) {
        results.enforce_equal(std::tie(idx, arg1, arg2, arg3), expected2);
      },
      [&](int idx, bool arg1, std::nullptr_t arg2, unsigned arg3) {
        results.enforce_equal(std::tie(idx, arg1, arg2, arg3), expected3);
      },
    },
    tup_idxs,
    tup1,
