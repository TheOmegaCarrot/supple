...
static_assert(std::
                is_same_v<func_wrapper_type_test::func_t<int>, const int>);
...
static_assert(supl::tl::
                apply_wrapped_v<func_wrapper_value_test, const int>);
...
static_assert(std::is_same_v<
              typename supl::tl::
                apply_wrapped<func_wrapper_type_test, int>::type,
              const int>);
...
static_assert(supl::tl::
                contains_v<int, supl::tl::type_list<int, char, bool>>);

static_assert(supl::tl::
                contains_v<int, supl::tl::type_list<char, bool, int>>);

static_assert(supl::tl::
                contains_v<int, supl::tl::type_list<char, int, bool>>);

static_assert(not supl::tl::
                contains_v<int, supl::tl::type_list<char, bool, float>>);
...
static_assert(not supl::tl::
                contains_v<int, std::tuple<char, bool, float>>);
...
static_assert(std::is_same_v<
              supl::tl::
                concat_t<supl::tl::type_list<>, supl::tl::type_list<>>,
              supl::tl::type_list<>>);
...
static_assert(std::is_same_v<
              ...
              supl::tl::
                type_list<int, char, bool, float, unsigned, void>>);
...
static_assert(std::is_same_v<
              supl::tl::front_t<supl::tl::type_list<int>>,
              int>);

static_assert(std::is_same_v<
              supl::tl::front_t<std::tuple<int, bool, char>>,
              int>);
...
static_assert(std::is_same_v<
              supl::tl::back_t<supl::tl::type_list<int>>,
              int>);

static_assert(std::is_same_v<
              supl::tl::back_t<std::tuple<int, bool, char>>,
              char>);
...
static_assert(std::is_same_v<
              supl::tl::
                at_index_t<0, supl::tl::type_list<int, char, bool>>,
              int>);

static_assert(std::is_same_v<
              supl::tl::
                at_index_t<2, supl::tl::type_list<int, char, bool>>,
              bool>);

static_assert(std::is_same_v<
              supl::tl::
                at_index_t<1, supl::tl::type_list<int, char, bool>>,
              char>);

static_assert(std::is_same_v<
              supl::tl::at_index_t<0, std::tuple<int, char, bool>>,
              int>);

static_assert(std::is_same_v<
              supl::tl::at_index_t<2, std::tuple<int, char, bool>>,
              bool>);

static_assert(std::is_same_v<
              supl::tl::at_index_t<1, std::tuple<int, char, bool>>,
              char>);
...
static_assert(std::is_same_v<
              supl::tl::type_list<int, char, bool>,
              supl::tl::
                push_back_t<supl::tl::type_list<int, char>, bool>>);
...
static_assert(std::is_same_v<
              ...
              supl::tl::
                push_back_t<supl::tl::type_list<>, bool, float, double>>);
...
static_assert(std::is_same_v<
              ...
              supl::tl::
                push_back_t<std::tuple<int, char>, bool, float, double>>);
...
static_assert(std::is_same_v<
              ...
              supl::tl::
                push_front_t<supl::tl::type_list<int, char>, bool>>);
...
static_assert(std::is_same_v<
              supl::tl::type_list<bool, float, double>,
              supl::tl::
                push_front_t<supl::tl::type_list<>, bool, float, double>>);
...
static_assert(std::is_same_v<
              ...
              supl::tl::
                push_front_t<std::tuple<int, char>, bool, float, double>>);
...
static_assert(std::is_same_v<
              supl::tl::
                drop_front_n_t<supl::tl::type_list<bool, int, char>, 2>,
              supl::tl::type_list<char>>);

static_assert(std::is_same_v<
              supl::tl::
                drop_front_n_t<supl::tl::type_list<bool, int, char>, 1>,
              supl::tl::type_list<int, char>>);

static_assert(std::is_same_v<
              supl::tl::
                drop_front_n_t<supl::tl::type_list<bool, int, char>, 3>,
              supl::tl::type_list<>>);

static_assert(std::is_same_v<
              supl::tl::
                drop_front_n_t<supl::tl::type_list<bool, int, char>, 0>,
              supl::tl::type_list<bool, int, char>>);
...
static_assert(std::is_same_v<
              supl::tl::
                drop_back_n_t<supl::tl::type_list<bool, int, char>, 2>,
              supl::tl::type_list<bool>>);

static_assert(std::is_same_v<
              supl::tl::
                drop_back_n_t<supl::tl::type_list<bool, int, char>, 1>,
              supl::tl::type_list<bool, int>>);

static_assert(std::is_same_v<
              supl::tl::
                drop_back_n_t<supl::tl::type_list<bool, int, char>, 3>,
              supl::tl::type_list<>>);

static_assert(std::is_same_v<
              supl::tl::
                drop_back_n_t<supl::tl::type_list<bool, int, char>, 0>,
              supl::tl::type_list<bool, int, char>>);
...
static_assert(std::is_same_v<
              supl::tl::sublist_t<
                supl::tl::
                  type_list<int, char, bool, float, double, std::size_t>,
                0,
                3>,
              supl::tl::type_list<int, char, bool>>);
...
static_assert(std::is_same_v<
              supl::tl::insert_t<
                ...
                std::size_t>,
              supl::tl::
                type_list<int, char, double, std::size_t, bool, float>>);
...
static_assert(std::is_same_v<
              supl::tl::insert_t<
                ...
                std::size_t>,
              supl::tl::
                type_list<double, std::size_t, int, char, bool, float>>);
...
static_assert(std::is_same_v<
              supl::tl::
                replace_t<supl::tl::type_list<int, char, bool>, 0, double>,
              supl::tl::type_list<double, char, bool>>);

static_assert(std::is_same_v<
              supl::tl::
                replace_t<supl::tl::type_list<int, char, bool>, 1, double>,
              supl::tl::type_list<int, double, bool>>);

static_assert(std::is_same_v<
              supl::tl::
                replace_t<supl::tl::type_list<int, char, bool>, 2, double>,
...
static_assert(not supl::tl::all_of_v<
              supl::tl::type_list<double, float, bool>,
              std::is_integral>);

static_assert(not supl::tl::all_of_v<
              supl::tl::type_list<int, float, double>,
              std::is_integral>);
...
static_assert(supl::tl::any_of_v<
              supl::tl::type_list<float, double, int>,
              std::is_integral>);
...
static_assert(std::is_same_v<
              supl::tl::
                transform_t<supl::tl::type_list<int>, std::add_const>,
...
static_assert(std::is_same_v<
              supl::tl::reorder_t<
                supl::tl::
                  type_list<int, char, const int, void*, double, bool, char>,
                0,
                4,
                3,
                6,
...
static_assert(std::is_same_v<
              supl::tl::split_t<
                supl::tl::
                  type_list<int, char, bool, float, double, unsigned>,
                3>,
              std::pair<
                supl::tl::type_list<int, char, bool>,
...
static_assert(std::is_same_v<
              supl::tl::deduplicate_t<supl::tl::type_list<
                ...
                int()>>,
              supl::tl::
                type_list<int, char, int&, int(), int(int), char*>>);
