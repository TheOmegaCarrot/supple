...
ehanc::test test_sum_type()
{
	...
	result.add_case(std::is_same_v<ehanc::sum_type_t<double, double>, double>, true);
	result.add_case(std::is_same_v<ehanc::sum_type_t<double, int>, double>, true);
	result.add_case(std::is_same_v<ehanc::sum_type_t<double, float>, double>, true);
	result.add_case(std::is_same_v<ehanc::sum_type_t<ehanc::lazy<int>, int>, int>, true);
