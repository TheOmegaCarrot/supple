...
ehanc::test test_is_lazy_of() {
  ...
  result.add_case(ehanc::is_lazy_of_v<int, volatile ehanc::lazy<int>>, true);
  result.add_case(ehanc::is_lazy_of_v<int, const volatile ehanc::lazy<int>>,
                  true);
  result.add_case(ehanc::is_lazy_of_v<int, ehanc::lazy<int> &>, true);
  result.add_case(ehanc::is_lazy_of_v<int, const ehanc::lazy<int> &>, true);
  result.add_case(ehanc::is_lazy_of_v<int, volatile ehanc::lazy<int> &>, true);
  ...
  result.add_case(ehanc::is_lazy_of_v<char, const ehanc::lazy<int>>, false);
  result.add_case(ehanc::is_lazy_of_v<char, volatile ehanc::lazy<int>>, false);
  result.add_case(ehanc::is_lazy_of_v<char, const volatile ehanc::lazy<int>>,
                  false);
  result.add_case(ehanc::is_lazy_of_v<char, ehanc::lazy<int> &&>, false);
  result.add_case(ehanc::is_lazy_of_v<char, const ehanc::lazy<int> &&>, false);
...
ehanc::test test_lazy_inner_type() {
  ...
  result.add_case(
      std::is_same_v<int, ehanc::lazy_inner_type_t<ehanc::lazy<int>>>, true);
  result.add_case(
  ...
  result.add_case(
      ...
      true);
  result.add_case(
      std::is_same_v<char, ehanc::lazy_inner_type_t<ehanc::lazy<int>>>, false);
  result.add_case(
      std::is_same_v<char, ehanc::lazy_inner_type_t<const ehanc::lazy<int>>>,
      false);
  result.add_case(
      std::is_same_v<char, ehanc::lazy_inner_type_t<volatile ehanc::lazy<int>>>,
      false);
  result.add_case(
      std::is_same_v<char,
                     ehanc::lazy_inner_type_t<const volatile ehanc::lazy<int>>>,
  ...
  result.add_case(
      std::is_same_v<
          char, ehanc::lazy_inner_type_t<const volatile ehanc::lazy<int> &&>>,
      false);
  result.add_case(std::is_same_v<int, ehanc::lazy_inner_type_t<int>>, true);
